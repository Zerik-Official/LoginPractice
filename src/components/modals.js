    ...
    >
      <div class="w-full max-w-lg bg-zinc-900 border border-white/10 rounded-2xl p-6 shadow-2xl">
        ...
        <div class="flex items-center justify-between mb-6">
          ...
          <button
            id="close-edit-modal"
            class="text-zinc-400 hover:text-white text-xl transition-all"
          >
        ...
        <form id="edit-product-form" class="space-y-4">
          ...
          <div class="flex justify-end gap-3 pt-4">
            ...
            <button
              type="button"
              id="cancel-edit-btn"
              class="bg-white/10 hover:bg-white/20 px-5 py-3 rounded-xl font-medium transition-all active:scale-95"
            >
              Cancelar
            </button>
            ...
            <button
              type="submit"
              class="bg-emerald-500 hover:bg-emerald-600 px-5 py-3 rounded-xl font-semibold transition-all active:scale-95"
            >
              Guardar cambios
            </button>
...
export function confirmModal({
  ...
  // TODO: Mas adelante, sacarle responsabilidades al componente y delegarlas a otros archivos o controllers.
        ...
        <div class="flex flex-col items-center text-center">
          ...
          <div class="flex items-center gap-3 w-full">
            ...
            <button
              ...
              class="flex-1 bg-white/10 hover:bg-white/20 py-3 rounded-xl font-medium transition-all active:scale-95"
            >
              Cancelar
            </button>
            ...
            <button
              ...
              class="flex-1 py-3 rounded-xl font-semibold transition-all active:scale-95 ${current.buttonStyle}"
            >
              ${current.buttonText}
            </button>
